...
export const FormIntakeSteunzolenPage = () => {
  ...
  const handleSubmit = () => {
    dispatch(setIntakeSteunzolenData({
      processes,
      schoenteest: {
        berekteKloonzool,
        berekteKustvlakte,
  ...
  return (
    <BaseLayout
      title="Intakeformulier Steunzolen"
      showBackButton={true}
    ...
    >
      ...
      >
        {/* Processes */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Processes</Text>
          <FormControl>
            <Input
        ...
        {/* Schoenteest */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Schoenteest</Text>
          <Box
            border="1px solid"
            borderColor="inherit"
            borderRadius="md"
        ...
        {/* Steunzolen */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Steunzolen</Text>
          <Box
            border="1px solid"
            borderColor="inherit"
            borderRadius="md"
        ...
        {/* Corrections */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Correcties</Text>
          <Box
            border="1px solid"
            borderColor="inherit"
            borderRadius="md"
        ...
        {/* Pads */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Pads</Text>
          <Box
            border="1px solid"
            borderColor="inherit"
            borderRadius="md"
        ...
        {/* Other Fields */}
        <Box>
          <Text fontWeight="bold" mb={3} fontSize={{ base: 'md', md: 'lg' }}>Details</Text>
          <Stack spacing={3}>
            <FormControl>
